...
describe.only('schema_macro.ts', () => {
    ...
    describe(get_schema_diff.name, () => {
        test('can remove and add field', async () => {
            const new_schema = {
                ...global_test_schema,
                $entities: {
            ...
            await test_mutate_custom_schema(new_schema, {
                users: [
                    {
                        $operation: 'create',
                        id: 1,
    ...
    test('adds foreign keys to existing entities', () => {
        const new_schema = {
            ...global_test_schema,
            $entities: {
                ...global_test_schema.$entities,
